...
class VisionTransformer(nn.Module):
    def __init__(self, input_resolution: int, patch_size: int, width: int, layers: int, heads: int, use_grad_checkpointing: bool):
        ...
        self.conv1 = nn.Conv2d(in_channels=1, out_channels=width, kernel_size=patch_size, stride=patch_size, bias=False)#灰度图inchannel==1
...
def create_clip_vit_L(img_size=224, patch_size = 14,use_checkpoint=False,precision="fp16"):
